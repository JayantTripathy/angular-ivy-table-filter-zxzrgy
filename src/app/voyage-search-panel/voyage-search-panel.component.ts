...
export class VoyageSearchPanelComponent implements OnInit {
  ...
  getFilterPredicate() {
    return (row: Voyage, filters: string) => {
      ...
      const billstatusByValue = filterArray[3];
      ...
      const columnbillstatusByValue = row.billstatus;
      ...
      const customFilterBillAs = columnbillstatusByValue
        .toLowerCase()
        .includes(billstatusByValue);

      // push boolean values into array
      matchFilter.push(customFilterDD);
      matchFilter.push(customFilterDS);
      matchFilter.push(customFilterAS);
      matchFilter.push(customFilterBillAs);
  ...
  unavailableSeats(seats: Seat[]): number {
    return seats.filter((seat) => seat.status === SeatStatus.UNAVAILABLE)
      .length;
  }
...
const VOYAGES: Voyage[] = [
  {
    id: 1,
    departureDate: new Date('2020-01-16'),
    route: ROUTE_P_S,
    seats: SEATS_K_D,
    billstatus: 'Paid',
  },
  ...
  {
    id: 3,
    departureDate: new Date('2020-01-17'),
    route: ROUTE_K_D,
    seats: SEATS_K_D,
    billstatus: 'Paid',
  },
  ...
  {
    id: 5,
    departureDate: new Date('2020-01-19'),
    route: ROUTE_U_K,
    seats: SEATS_K_D,
    billstatus: 'Paid',
  },
  ...
  // {
  //   id: 7,
  //   departureDate: new Date('2020-01-20'),
  //   route: ROUTE_K_D,
  //   seats: SEATS_K_D,
  // },
  // {
  ...
  // {
  //   id: 9,
  //   departureDate: new Date('2020-01-22'),
  //   route: ROUTE_U_K,
  //   seats: SEATS_K_D,
  // },
  // {
  ...
  // {
  //   id: 12,
  //   departureDate: new Date('2020-01-24'),
  //   route: ROUTE_K_D,
  //   seats: SEATS_K_D,
  // },
  // {
  ...
  // {
  //   id: 14,
  //   departureDate: new Date('2020-01-26'),
  //   route: ROUTE_K_D,
  //   seats: SEATS_K_D,
  // },
  // {
  ...
  // {
  //   id: 16,
  //   departureDate: new Date('2020-01-28'),
  //   route: ROUTE_U_K,
  //   seats: SEATS_K_D,
  // },
  // {
  ...
  // {
  //   id: 18,
  //   departureDate: new Date('2020-01-27'),
  //   route: ROUTE_P_S,
  //   seats: SEATS_K_D,
  // },
  // {
  ...
  // {
  //   id: 20,
  //   departureDate: new Date('2020-01-23'),
  //   route: ROUTE_K_D,
  //   seats: SEATS_K_D,
  // },
  // {
